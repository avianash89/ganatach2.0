          ...
          <div className="md:w-1/3 py-20 md:py-0 text-center md:text-start md:border-r w-full border-text-secondary border-b md:border-b-0 px-4 relative overflow-hidden bg-red-50">
            ...
            <motion.div className="flex flex-col gap-y-10 md:mt-30 lg:mt-50 md:pl-10 lg:pl-10 relative z-10">
              <motion.h2
                ...
                <h2>
                  About <span className="text-blue-600">GanaTech</span>
                </h2>
              </motion.h2>
              ...
              <motion.p
                ...
                <p className="text-text-secondary leading-relaxed mb-4">
                  To become the most respected IT Training, Corporate Training
                  provider, Mobile & Web application development and solutions
                  company in the world through world-class, quality,
                  result-oriented products and services with a focus on emerging
                  technologies where the best in the industry want to work for
                  the job satisfaction and professional growth it provides.
                </p>
                <p className="text-text-secondary leading-relaxed">
                  Gana Tech not only teaches you just theory but gives
                  assignment training on real-time requirements and Project
                  Oriented Training with project management skills.
                </p>
              </motion.p>
            </motion.div>
          </div>
          ...
          <div className="md:flex-1 relative">
            <div className="h-auto md:px-20 flex flex-col items-center gap-y-10 my-10 md:block">
              <motion.div
                ...
                <AheroCard
                  primaryText="Reach Us"
                  secondaryText={
                    <>
                      <p className="text-text-secondary mb-4">
                        Contact us @{" "}
                        <span className="font-semibold">Gana Tech</span>
                      </p>
                      <p className="text-text-secondary leading-relaxed">
                      ...
                      <p className="mt-4 text-text-secondary">
                        📞 <span className="font-medium text-gray-300">+91 8340901901</span>
                      </p>
              ...
              <motion.div
                className="md:w-[240px] md:absolute left-[340px] top-60"
                  ...
                  secondaryText={
                    <>
                      <p className="text-gray-300">
                        📞 Phone:{" "}
                        <span className="font-medium text-gray-300">+91 8340 901 901</span>
                      </p>
